...
(function () {
    ...
    var OnePageNav = function () {
        var navToggler = $('.agnes-js-nav-toggle');
        $(".smoothscroll[href^='#'], #agnes-navbar ul li a[href^='#']").on('click', function (e) {
            e.preventDefault();
            var hash = this.hash;
            $('html, body').animate({
        ...
        $("#agnes-navbar ul li a[href^='#']").on('click', function (e) {
    ...
    $('.agnes-js-nav-toggle').on('click', function (e) {
        var $this = $(this);
        e.preventDefault();
        if ($('body').hasClass('menu-open')) {
            $this.removeClass('active');
            $('.agnes-menu .agnes-menu-inner > ul > li').each(function (i) {
                var that = $(this);
                setTimeout(function () {
            ...
            setTimeout(function () {
                $('.agnes-menu').removeClass('agnes-menu-show');
            }, 800);
            $('body').removeClass('menu-open');
        }
        else {
            $('.agnes-menu').addClass('agnes-menu-show');
    ...
    $('.agnes-menu .dropdown').hover(function () {
        var $this = $(this);
        $this.addClass('show');
